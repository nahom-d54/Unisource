...
urlpatterns = [
    ...
    path('rating/<int:resource>/', views.RatingViewset.as_view({'get': 'list', 'post': 'create'}), name='rating-list'),
    path('rating/<int:resource>/<int:pk>/', views.RatingViewset.as_view({'get': 'retrieve', 'put': 'update', 'delete': 'destroy'}), name='rating-detail'),
]
